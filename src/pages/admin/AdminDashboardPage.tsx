...
const PIE_COLORS = ['#fbbf24', '#60a5fa', '#6366f1', '#a855f7', '#22c55e', '#ef4444'];
              ...
              {recentOrders.map((order) => (
                <tr key={order.id} className="border-b border-gray-100">
                  ...
                  <td className="px-2 py-3">
                    <Link to="/admin/orders" className="text-sm font-semibold text-indigo-600 hover:text-indigo-700">
                      View
                    </Link>
                  </td>
                </tr>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {lowStockProducts.map((product) => (
              <article key={product.id} className="rounded-xl border border-yellow-200 bg-yellow-50 p-3">
                ...
                <Link to={`/admin/products/${product.id}/edit`} className="mt-2 inline-block text-sm font-semibold text-indigo-600">
                  Edit
                </Link>
              </article>
            ))}
