          ...
          <div className="grid gap-6 lg:grid-cols-[340px_minmax(0,1fr)]">
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              <div className="flex flex-col items-center text-center">
                <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-sky-600 text-3xl font-black text-white">
                  {initials}
                </div>
              ...
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  ...
                  {hasAdminAccess(user) ? (
                    <Link
                      to="/admin/dashboard"
                      className="rounded-xl bg-sky-100 px-4 py-2.5 text-sm font-semibold text-sky-700 transition-colors hover:bg-sky-200"
                    >
                      Go to Admin Panel
                    </Link>
                  ) : null}
